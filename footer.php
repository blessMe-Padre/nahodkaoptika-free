<footer class="footer page-section-3 bg-black pb-10 pt-10">
    <div class="container ">
        <div class="footer-border-bottom footer__wrapper">

            <div>
                <img class="mb-8" src="<?php echo get_template_directory_uri() ?>/src/img/footer-logo.svg" width="153"
                    height="40" alt="logo">
                <ul>
                    <li class="mb-3">
                        <a class="text-white hover:underline" href="tel:+79147085183">+7 914 708-51-83</a>
                    </li>
                    <li class="mb-3r">
                        <a class="text-white hover:underline"
                            href="mailto:info@nakhodkaoptik.ru">info@nakhodkaoptik.ru</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="social-list">
                    ...
                    <li>
                        <a class="social-link" href="#">
                            <svg class="social-link__telegram" width="20" height="17" viewBox="0 0 20 17" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <div class="container">
        <div class="flex items-center justify-between text-white pt-10">
            <div class="md:text-sm text-xs">
                ©<span class="data-span"></span> «Находка Оптик». Все права защищены
            </div>
